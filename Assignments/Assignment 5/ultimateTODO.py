# Muhammad Muhamedjonov, 11-14-2025
# Assignment 5, COM S 1270 - 02 (LAB K)
#
# This is a little, simple application for tracking the completion of tasks.
...
def addItem(item, toList, todoList):
    ...
    if(itemFound == False):
        ...
        print("Error: The item is already in todoList")
        print(f"Name of item: {item}")
        print(f"Key name of the list: {keyName}")
        print(f"Index of the item: {index}")
...
def deleteItem(item, todoList):
    ...
    if(itemFound == True):
        ...
        print("Error: The item is not in the todoList")
        print(f"Name of item: {item}")
        # print(f"Key name of the list: {keyName}")
        # print(f"Index of the item: {index}")
...
def runApplication(todoList):
    ...
    while True:
        ...
        if choice == "a":
            ...
            empty = checkIfListEmpty(todoList)
            ...
            if(empty == False):
                ...
                while(itemFound == False):
                    print("Error: The item does not exist")
                    item = str(input("Enter different item: "))
                    itemFound, keyName, index = checkItem(item, todoList)

                key = str(input("Enter a key: "))
                while((key in todoList) == False):
                    print("Error: The key does not exist")
                    key = str(input("Enter a key: "))
            
                moveItem(item, key, todoList)
