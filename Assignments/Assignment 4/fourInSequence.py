# Muhammad Muhamedjonov, 11-02-2025
# Assignment 4, COM S 1270 - 02 (LAB K)
#
# This is a code, version of the classic boardgame 'Connect Four' or 'Four in Sequence!'

"""
Connect Four is a two-player game played on a vertical grid with 7 columns and 6 rows.
Players take turns dropping colored discs into the columns. The discs fall to the lowest available space in that column.
The goal is to be the first player to form a straight line of four of their own discs - either horizontally, vertically, or diagonally.
...
def main():
    ...
    while running:
        ...
        if choice == "p":
            ...
            print("- A two player game has two users play against each other.")
            print("- Each player takes turns 'dropping' their 'pieces' into the board.")
            print("- The goal is for player to connect four pieces in an unbroken sequence.")
